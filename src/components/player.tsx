...
const Player = () => {
  return (
    <div className="fixed bottom-0 right-0 z-50 flex h-20 w-full items-center border-t border-input bg-primary-foreground">
      ...
      <div className="w-full px-4">
        <div className="grid w-full grid-cols-5">
          <div className="col-span-1 flex items-center">
            ...
            <div className="ml-3 text-[13px] text-primary">0:00 / 1:23</div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="mx-3">
                ...
                <div className="-mt-1 text-sm font-light text-muted-foreground">
                  Marshemello on the beast & Sam smith
                </div>
              </div>
              <div className="flex items-center">
                <Button size="icon" variant="ghost">
